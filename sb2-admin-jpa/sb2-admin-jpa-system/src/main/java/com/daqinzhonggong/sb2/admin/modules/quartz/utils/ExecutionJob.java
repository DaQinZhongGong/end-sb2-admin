...
import com.daqinzhonggong.sb2.admin.modules.quartz.repository.QuartzLogRepository;
...
public class ExecutionJob extends QuartzJobBean {
  ...
  private final ThreadPoolTaskExecutor executor = SpringContextHolder.getBean("adminAsync");
  ...
  public void executeInternal(JobExecutionContext context) {
    ...
    // 获取spring bean
    QuartzLogRepository quartzLogRepository = SpringContextHolder.getBean(
    ...
    try {
      ...
      logger.info(
          "任务执行成功，任务名称：" + quartzJob.getJobName() + ", 执行时间：" + times + "毫秒");
      // 判断是否存在子任务
