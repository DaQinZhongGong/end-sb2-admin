...
public class DictController {
  ...
  @GetMapping
  @PreAuthorize("@el.check('dict:list')")
  public ResponseEntity<PageResult<DictDto>> queryDict(DictQueryCriteria resources,
      Pageable pageable) {
  ...
  public ResponseEntity<Object> updateDict(@Validated(Update.class) @RequestBody Dict resources) {
