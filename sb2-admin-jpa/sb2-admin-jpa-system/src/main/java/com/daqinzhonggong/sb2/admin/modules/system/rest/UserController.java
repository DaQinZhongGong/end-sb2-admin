...
public class UserController {
  ...
  @GetMapping
  @PreAuthorize("@el.check('user:list')")
  public ResponseEntity<PageResult<UserDto>> queryUser(UserQueryCriteria criteria,
      Pageable pageable) {
  ...
  public ResponseEntity<Object> updateUser(@Validated(Update.class) @RequestBody User resources)
      throws Exception {
    checkLevel(resources);
  ...
  public ResponseEntity<Object> centerUser(@Validated(Update.class) @RequestBody User resources) {
  ...
  public ResponseEntity<Object> deleteUser(@RequestBody Set<Long> ids) {
    for (Long id : ids) {
      ...
      Integer optLevel = Collections.min(
          roleService.findByUsersId(id).stream().map(RoleSmallDto::getLevel)
