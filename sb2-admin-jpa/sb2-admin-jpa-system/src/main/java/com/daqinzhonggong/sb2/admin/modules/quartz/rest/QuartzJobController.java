...
import com.daqinzhonggong.sb2.admin.modules.quartz.service.dto.JobQueryCriteria;
...
public class QuartzJobController {
  ...
  public ResponseEntity<PageResult<QuartzJob>> queryQuartzJob(JobQueryCriteria criteria,
      Pageable pageable) {
  ...
  @PreAuthorize("@el.check('timing:list')")
  public ResponseEntity<PageResult<QuartzLog>> queryQuartzJobLog(JobQueryCriteria criteria,
      Pageable pageable) {
