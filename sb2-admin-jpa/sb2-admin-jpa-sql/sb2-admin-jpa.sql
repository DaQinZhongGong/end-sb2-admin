/*
 ...
 Source Schema         : sb2-admin-jpa

 Target Server Type    : MySQL
 Target Server Version : 80027 (8.0.27)
 File Encoding         : 65001

 Date: 02/04/2024 20:05:05
*/

/*
    ROW_FORMAT=COMPACT : COMPACT是一种紧凑的行格式，适用于包含固定长度字段的表。它可以减少存储空间的使用，提高查询性能。
 */

DROP DATABASE IF EXISTS `sb2-admin-jpa`;
CREATE DATABASE `sb2-admin-jpa` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
SET NAMES utf8mb4;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 2, 'admin', '管理员', '男', '18888888888', '88888888@qq.com', NULL, NULL, '$2a$10$Egp1/gvFlt7zhlXVfEFw4OfWQCGPw0ClmMcc6FjTnvXNRVf9zdMRa', b'1', b'1', NULL, 'admin', '2020-05-03 16:38:31', '2018-08-23 09:11:56', '2020-09-05 10:43:31');
