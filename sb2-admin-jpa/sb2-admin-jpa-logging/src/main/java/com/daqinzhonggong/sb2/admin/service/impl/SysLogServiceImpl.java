...
import com.daqinzhonggong.sb2.admin.repository.LogRepository;
...
import com.daqinzhonggong.sb2.admin.service.mapstruct.LogErrorMapper;
import com.daqinzhonggong.sb2.admin.service.mapstruct.LogSmallMapper;
...
public class SysLogServiceImpl implements SysLogService {
  ...
  public Object queryAll(SysLogQueryCriteria criteria, Pageable pageable) {
    Page<SysLog> page = logRepository.findAll(
  ...
  @Override
  public PageResult<SysLogSmallDto> queryAllByUser(SysLogQueryCriteria criteria,
      Pageable pageable) {
    Page<SysLog> page = logRepository.findAll(
        ((root, criteriaQuery, cb) -> QueryHelp.getPredicate(root, criteria, cb)), pageable);
  ...
  public void download(List<SysLog> sysLogs, HttpServletResponse response) throws IOException {
    ...
    for (SysLog sysLog : sysLogs) {
      ...
      map.put("异常详情", new String(
          ObjectUtil.isNotNull(sysLog.getExceptionDetail()) ? sysLog.getExceptionDetail()
              : "".getBytes()));
